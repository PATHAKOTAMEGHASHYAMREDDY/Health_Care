...
const DoctorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await register(submitData, 'doctor');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Join as a Doctor</h2>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    {isVerifyingEmail ? (
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Upload a professional photo (JPEG, PNG, GIF - Max 5MB)
                  </p>
                  {imageError && (
